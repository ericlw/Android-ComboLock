	...
	private class MyOnTouchListener implements OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				float scaled = rotationDegrees * factor;
				
				/*tickNumber = (int)rotationDegrees*100/360;
				...
				TextView tick = (TextView)findViewById(R.id.tickNumber);
				tick.setText(String.valueOf((int)scaled));
